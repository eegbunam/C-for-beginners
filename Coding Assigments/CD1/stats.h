// Provided by:   ____________(your name here)Ebuka Egbunam
// Email Address: ____________(your email address here)eegbuname@student.cod
// FILE: stats.h
...
namespace main_savitch_2C
{
    ...
    public:
        ...
        double minimum( ) const;
        double maximum( ) const;
        vector<double> data; // stream of data
        // FRIEND FUNCTIONS
        friend statistician operator +
            (const statistician& s1, const statistician& s2);
        friend statistician operator *
            (double scale, const statistician& s);
        friend bool test( statistician s1, statistician s2);
    private:
        int testNumber;
